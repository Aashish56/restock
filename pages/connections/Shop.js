  ...
  <>
    ...
    <View style={styles.container}>
              ...
              <View style={styles.headerContainer}>
                  ...
                  <View style={styles.headeritem1}>
                      ...
                      <View>
                          <View style={styles.Available}>
                              <Text style={{color:'white',fontSize:9,fontWeight:'600'}}>AVAILABLE</Text>
                          </View>
                      </View>
                  </View>
                  ...
                  <View style={styles.headeritem2}>
                      ...
                      <View style={styles.menuButton}>
                          ...
                          <Text style={styles.menuButtonText1}>GST</Text>
                      </View>
                      ...
                      <View style={styles.menuButton}>
                          ...
                          <Text style={styles.menuButtonText1}>KYC</Text>
                      </View>
                  </View>
              ...
              <ScrollView style={{paddingBottom:'100px'}}>
               <View style={{ display:'flex',paddingHorizontal:12,paddingVertical:10}}>
              <Text style={{color:'#999999',fontSize:12,fontWeight:'500'}}>Business Address</Text>
              <Text style={{fontSize:12,fontWeight:'500',paddingTop:8}}>#34, Sector 71, Mohali, Punjab, India</Text>
              
              <Text style={{color:'#999999',fontSize:12,fontWeight:'500',paddingTop:15}}>Primary Category</Text>
              <Text style={{fontSize:12,fontWeight:'500',paddingTop:8}}>Electronics, Textiles</Text>
              ...
              <View style={{display:'flex',flexDirection:'row'}}>
                  ...
                  <Text style={{color:'#999999',fontSize:16,fontWeight:'600',paddingLeft:4}}>(2)</Text>
                  </View>
                  </View>
