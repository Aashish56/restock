        ...
        <>
            ...
            <View style={styles.container}>
                ...
                <View style={{ height: '90%' }}>
                    ...
                    <ScrollView style={{ paddingBottom: '100px' }} showsHorizontalScrollIndicator={false}>
                        <View style={styles.headingContainer}>
                            <Text style={{ fontSize: 16, fontWeight: '700' }}>Inbox</Text>
                        ...
                        <View style={{ paddingBottom: '100px' }}>
                            <View style={styles.card}>
                                ...
                                <View style={styles.notification}>
                                    <Text style={{ color: 'white', fontSize: 10, fontWeight: '500' }}>6</Text>
                            ...
                            <View style={styles.card}>
                                ...
                                <View style={styles.notification}>
                                    <Text style={{ color: 'white', fontSize: 10, fontWeight: '500' }}>2</Text>
